...
if(buffer_exists(znet_server_buffer))
    buffer_delete(znet_server_buffer);
    
if(ds_exists(znet_socket_list, ds_type_list))
    ds_list_destroy(znet_socket_list);
    
if(ds_exists(znet_socket_id_list, ds_type_list))
    ds_list_destroy(znet_socket_id_list);
